...
# Changing the plotting parameters to plot into a 2x2 panel matrix.
par(mfrow=c(2,2))
...
my.ylab <- "Voltage"
my.xlab <- "datetime"
with( data, plot(fulltime,Voltage,type="l",ylab=my.ylab,xlab=my.xlab) )

# Third plot: botton left
...
# Fourth plot: botton right
my.ylab <- "Global reactive power"
my.xlab <- "datetime"
with( data, plot(fulltime,Global_reactive_power,type="l",ylab=my.ylab,xlab=my.xlab) )
